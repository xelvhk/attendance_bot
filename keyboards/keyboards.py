...
yatut_button_5 = KeyboardButton(text=LEXICON_RU['week'])
yatut_button_6 = KeyboardButton(text=LEXICON_RU['month'])
yatut_button_7 = KeyboardButton(text=LEXICON_RU['clear_stats'])
